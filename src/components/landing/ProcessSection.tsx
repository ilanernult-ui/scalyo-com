          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl glass-card mb-4 relative">
                  <step.icon className="h-7 w-7 text-primary" />
                  <span className="absolute -top-2 -right-2 text-xs font-bold text-primary bg-primary/10 rounded-full w-6 h-6 flex items-center justify-center">
                    {step.number}
                  </span>
                </div>
