      ...
      <section style={{ paddingTop: "clamp(100px, 12vh, 140px)", paddingBottom: "80px" }}>
        <div className="container mx-auto px-4">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="max-w-3xl mx-auto surface rounded-[18px] p-10 mb-20"
          >
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <h2 className="text-2xl font-semibold text-foreground text-center mb-10 tracking-tight">Nos valeurs</h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {values.map((v, i) => (
                <motion.div
                  ...
                  className="apple-card flex gap-4"
                >
                  <div className="bg-primary/10 rounded-2xl p-3 h-fit">
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <h2 className="text-2xl font-semibold text-foreground text-center mb-10 tracking-tight">L'équipe</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {team.map((member, i) => (
                ...
                >
                  <div className="w-16 h-16 rounded-full surface mx-auto mb-4 flex items-center justify-center">
                    <span className="text-xl font-bold text-primary">{member.name.split(" ").map(n => n[0]).join("")}</span>
                  </div>
