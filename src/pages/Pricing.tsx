...
const plans = [
  {
    ...
    features: [
      { name: "Analyse données financières", included: true },
      { name: "Rapport de diagnostic mensuel", included: true },
      { name: "Détection automatique des anomalies", included: true },
      { name: "Dashboard KPIs essentiel", included: true },
      { name: "Alertes automatiques email", included: true },
      { name: "1 à 3 utilisateurs", included: true },
    ],
    excluded: [
      "Plan d'action IA",
    ...
    popular: false,
    target: "Idéal pour les TPE et indépendants",
  },
  {
    name: "GrowthPilot",
    monthly: 189,
    ...
    features: [
      ...
      { name: "Plan d'action IA personnalisé", included: true },
      { name: "Analyse ventes et taux de conversion", included: true },
      { name: "Détection des opportunités de croissance", included: true },
      { name: "Rapport de performance hebdomadaire", included: true },
      { name: "Recommandations priorisées par ROI", included: true },
    ...
    popular: true,
    target: "Idéal pour les PME en croissance",
  },
  {
    name: "LoyaltyLoop",
    monthly: 349,
    ...
    features: [
      ...
      { name: "Analyse et prédiction du churn client", included: true },
      { name: "Stratégies de rétention automatisées", included: true },
      { name: "Suivi clients en temps réel 360°", included: true },
      { name: "Utilisateurs illimités", included: true },
      { name: "Intégrations CRM avancées (Salesforce, HubSpot)", included: true },
      { name: "Onboarding personnalisé — 2h de setup", included: true },
      { name: "Account manager dédié", included: true },
    ],
    excluded: [],
    popular: false,
    target: "Idéal pour les ETI et grandes PME",
  },
];
